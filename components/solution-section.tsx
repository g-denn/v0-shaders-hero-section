  ...
  return (
    ...
    >
      <div className="container mx-auto px-6 lg:px-8">
        <div className="max-w-4xl mx-auto text-center space-y-8 bg-black/60 backdrop-blur-md rounded-3xl p-8 lg:p-12 border border-white/10">
          ...
          <div className="mt-16 grid md:grid-cols-3 gap-8">
            <div className="flex flex-col items-center gap-4 p-6 rounded-2xl bg-black/40 border border-white/20 backdrop-blur-sm">
              ...
              <h3 className="text-lg font-semibold text-white">Real Properties</h3>
